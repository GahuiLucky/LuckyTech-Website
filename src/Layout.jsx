          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-[#F5F2EB]/60">
                <li><Link to={createPageUrl('Handwerk')} className="hover:text-[#F5F2EB] transition-colors">Smarthome</Link></li>
                <li><Link to={createPageUrl('Handwerk')} className="hover:text-[#F5F2EB] transition-colors">Wallbox</Link></li>
                <li><Link to={createPageUrl('Handwerk')} className="hover:text-[#F5F2EB] transition-colors">Elektroinstallation</Link></li>
                <li><Link to={createPageUrl('Handwerk')} className="hover:text-[#F5F2EB] transition-colors">Reparatur & Service</Link></li>
              </ul>
            </div>
            <div>
