...
export default function ServiceRow({ service, index }) {
  ...
  return (
    ...
    >
      {/* Hover bg flash */}
      <motion.div
        className="absolute inset-0 bg-[#3B5BDB]/[0.03]"
        ...
        <div className="flex items-center justify-between gap-4">
          <div className="flex items-center gap-5 md:gap-8 flex-1 min-w-0">
            <span
              ...
              style={{ color: hovered || expanded ? '#3B5BDB' : 'rgba(255,255,255,0.15)' }}
            >
            ...
            <div className="relative">
              ...
              <motion.h3
                ...
                style={{
                  color: 'transparent',
                  WebkitTextStroke: '1px rgba(59,91,219,0.15)',
                }}
                animate={{
          ...
          <div className="hidden md:flex items-center gap-4 flex-shrink-0">
            ...
            <motion.div
              ...
              style={{
                borderColor: hovered || expanded ? '#3B5BDB' : 'rgba(255,255,255,0.08)',
                backgroundColor: hovered || expanded ? 'rgba(59,91,219,0.1)' : 'transparent',
              }}
            ...
            >
              <Icon
                ...
                style={{ color: hovered || expanded ? '#3B5BDB' : 'rgba(255,255,255,0.2)' }}
              />
            </motion.div>
          </div>
        </div>
            ...
            >
              <div className="pb-4">
                ...
                <div className="flex items-center gap-3 mb-4">
                  <span className="text-[10px] tracking-[0.4em] uppercase text-[#3B5BDB]/40 font-mono">
                    FEATURES
                  </span>
                  <div className="h-px flex-1 bg-[#3B5BDB]/10 max-w-xs" />
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-1.5 max-w-2xl">
                  {service.features.map((f, fi) => (
                    <motion.div
                      key={f}
                      className="flex items-center gap-3 py-2.5 px-3 border border-white/[0.04] hover:border-[#3B5BDB]/20 hover:bg-[#3B5BDB]/[0.03] transition-all duration-300 group"
