...
export default function SplitSection({ imgSrc, imgAlt, title, text, reverse = false, accent }) {
  return (
    <div className={`grid grid-cols-1 lg:grid-cols-2 gap-0 min-h-[60vh] ${reverse ? '' : ''}`}>
      {/* Image */}
      <motion.div
      ...
      >
        ...
        />
        <div className={`absolute inset-0 bg-gradient-to-${reverse ? 'l' : 'r'} from-transparent to-[#0A0A0A]/60`} />
      </motion.div>
