// src/components/handwerk/ServiceTilesWithDialog.jsx
...
const services = [
  {
    ...
    icon: Home,
    description:
      'Wir verwandeln Ihr Zuhause in ein intelligentes Ökosystem. Von der Lichtsteuerung über die Heizungsregelung bis zur kompletten Gebäudeautomation – alles reagiert auf Ihre Bedürfnisse.',
    features: [
      'KNX & Loxone Systeme',
      'Sprachsteuerung (Alexa, Google)',
      'Licht- & Jalousiesteuerung',
      'Heizungsautomation',
      'Multiroom-Audio',
      'Fernzugriff per App',
    ],
  ...
  {
    title: 'WALLBOX',
    tagline: 'Laden. Zuhause. Bald verfügbar.',
    icon: Car,
    comingSoon: true,
    description: '',
    features: [],
...

  {
    ...
    icon: Zap,
    description:
      'Ob Neubau, Sanierung oder Erweiterung – wir planen und installieren Ihre komplette Elektrik nach höchsten Standards. Normgerecht, zukunftssicher und sauber ausgeführt.',
    features: [
      'Neubau-Installation',
      'Altbau-Sanierung',
...

  {
    ...
    icon: Wrench,
    description:
      'Schnelle Hilfe bei elektrischen Problemen – von der defekten Steckdose bis zum Komplettausfall. Zuverlässig, kompetent und fair.',
    features: [
      'Fehlerdiagnose',
      'Reparatur & Austausch',
      'Sicherungswechsel',
      ...
      {services.map((s, i) => {
        ...
        return (
          <motion.div
            ...
            onMouseLeave={() => !disabled && setHoveredIdx(null)}
          ...
          >
            {/* Coming Soon Badge */}
            {disabled && (
              <div className="absolute top-4 left-4 bg-red-600 text-white text-[10px] px-2 py-1 rounded uppercase tracking-wide z-20">
                Coming Soon
              </div>
            )}
              ...
              <div className="flex items-center justify-between gap-4">
                <div className="flex items-center gap-5 md:gap-8 flex-1 min-w-0">
                  ...
                  <span
                    ...
                    style={{
                      color: isHovered || isExpanded ? '#BFFF00' : 'rgba(255,255,255,0.2)',
                    }}
                  >
                  ...
                  <motion.div
                    ...
                    style={{
                      borderColor: disabled
                        ...
                        : 'rgba(255,255,255,0.1)',
                      backgroundColor:
                        disabled || !(isHovered || isExpanded)
                          ? 'transparent'
                          : 'rgba(191,255,0,0.1)',
                    }}
                    animate={{
                      rotate: disabled ? 0 : isExpanded ? 45 : isHovered ? 90 : 0,
                    }}
                    transition={{ duration: 0.3 }}
                  >
                    <Icon
