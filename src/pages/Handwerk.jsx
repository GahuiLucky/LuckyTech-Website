  ...
  return (
    <div className="bg-[#0A0A0A] text-[#F5F2EB] overflow-x-hidden relative">
      ...
      <div className="relative z-10">
        ...
        >
          <motion.div
            className="flex-1 flex flex-col justify-between px-4 md:px-8 pt-20 pb-12"
        ...
        <section className="py-20 md:py-32 px-4 md:px-8">
          <div className="max-w-screen-xl mx-auto">
            ...
            >
              Wir sehen jede Installation als <span className="text-[#C8A850]">Designprojekt</span> –
              durchdacht, funktional, <span className="text-[#F5F2EB]/20">zukunftssicher.</span>
            </motion.p>
          </div>
        </section>
        ...
        <section className="px-4 md:px-8 pb-20 md:pb-32 relative overflow-hidden">
          ...
          <div className="max-w-screen-2xl mx-auto relative z-10">
            ...
            {/* SERVICE TILES (mit Coming Soon Wallbox) */}
