  ...
  return (
    <div className="bg-[#F5F2EB] text-[#0A0A0A]">
      ...
      <section className="min-h-screen flex items-center relative overflow-hidden px-6 py-20">
        <div className="absolute top-8 right-8 text-right text-sm">
          ...
          >
            <div>
              <h1 className="text-7xl md:text-9xl font-bold leading-none mb-12">
                HAND<br />
                WERK<br />
                <span className="text-[#C8A850]">(2025)</span>
              </h1>
            </div>
            
            <div>
              <div className="text-lg md:text-xl leading-relaxed text-[#0A0A0A]/70 mb-8">
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="mb-16">
            <h2 className="text-6xl md:text-8xl font-bold mb-6">LEISTUNGEN</h2>
          </div>
                ...
                <div className="p-8">
                  ...
                  <ul className="space-y-2 text-sm">
                    {service.features.map((feature) => (
                      <li key={feature} className="text-[#0A0A0A]/60">
                        — {feature}
                      </li>
                    ))}
                  </ul>
