  ...
  return (
    <div className="bg-[#0A0A0A] overflow-x-hidden relative">
      ...
      <div className="relative z-10">
        ...
        >
          {/* subtle logo behind the title (decorative) */}
          <img
            src="src/assets/luckytech-logo-transparent.png"
            alt=""
            aria-hidden="true"
            loading="lazy"
            className="pointer-events-none absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[60vw] max-w-[900px] opacity-20 mix-blend-screen filter-saturate-90"
            style={{ zIndex: 0 }}
          />
        ...
        >
          <div
            ...
            style={{
              backgroundImage:
                'repeating-linear-gradient(0deg, transparent, transparent 2px, rgba(10,10,10,0.15) 2px, rgba(10,10,10,0.15) 4px)',
            }}
          />
          ...
          >
            ...
            <div className="relative mb-16 md:mb-24">
              ...
              >
                ELEKTRO—<br />
                TECHNIK<span className="text-[#C8A850]">.</span>
              </motion.h2>
        ...
        >
          <div
            ...
            style={{
              backgroundImage:
                'repeating-linear-gradient(0deg, transparent, transparent 2px, rgba(59,91,219,0.2) 2px, rgba(59,91,219,0.2) 4px)',
            }}
          />
          ...
          >
            ...
            <div className="relative mb-16 md:mb-24">
              ...
              >
                INGENIEURS—<br />
                KUNST<span className="text-[#3B5BDB]">.</span>
              </motion.h2>
